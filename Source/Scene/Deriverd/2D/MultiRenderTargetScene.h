...
public:
	...
	static ScenePtrTemplate<MultiRenderTargetScene> Create(const std::filesystem::path& imagePath, const std::filesystem::path& pixelShaderPath, unsigned int num);
...
private:
	MultiRenderTargetScene(const std::filesystem::path& imagePath, const std::filesystem::path& pixelShaderPath, unsigned int num);
